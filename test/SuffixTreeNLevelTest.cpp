...
BOOST_AUTO_TEST_SUITE( suffix_tree_nlevel_test )

    BOOST_AUTO_TEST_CASE(vanillaTest_2Nodes)
    {
        aux::SuffixTreeTraits<2, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
        auto it = cont.insert("aaa-bbb", 777);
        assert(1 == cont.size());
        assert(cont.end() != it);
        assert(cont.end() != cont.find("aaa-bbb"));
        assert(cont.end() == cont.find("aaa-bba"));
    }

    BOOST_AUTO_TEST_CASE(vanillaTest_3Nodes)
    {
        aux::SuffixTreeTraits<3, std::string, int> builder;
        suffix_tree::SuffixTree<aux::SuffixTreeTraits<3, std::string, int>> cont(builder);
        assert(0 == cont.size());
        auto it = cont.insert("aaa-bbb-ccc", 777);
        assert(1 == cont.size());
        assert(cont.end() != it);
        assert(cont.end() != cont.find("aaa-bbb-ccc"));
        assert(cont.end() == cont.find("aaa-bbb-cca"));
    }

    BOOST_AUTO_TEST_CASE(invalidKeyTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(findNonexistTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(insertDuplicateTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE (eraseByKeyTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(eraseAgainByKeyTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(eraseByIteratorTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(setByIteratorTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(beginIteratorTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(copyEmptyContainerTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());

        suffix_tree::SuffixTree contCopy(cont);
    ...
    BOOST_AUTO_TEST_CASE(copyContainerTest_4Nodes)
    {
        aux::SuffixTreeTraits<4, std::string, int> builder(prepareLevel1Keys(), prepareLevel2Keys(), prepareLevel3Keys(), prepareLevel4Keys());
        suffix_tree::SuffixTree cont(builder);
        assert(0 == cont.size());
    ...
    BOOST_AUTO_TEST_CASE(addNewKeyTest_4Nodes)
    {
